        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Confirmed Reservations</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <?php
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <a href="<?= WEB_PATH ?>reservation/confirmed_reservations.php" class="btn btn-info btn-sm" style="font-size:13px;width:100px;"><i class="bi bi-eraser"></i> Clear</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-striped bg-light" style="font-size:13px;">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT r.reservation_id,r.reservation_no,r.event_date,r.start_time,r.end_time,"
                                    ...
                                    . "AND r.reservation_status_id='2' AND r.reservation_no NOT IN(SELECT reservation_no FROM arrangement_plan) $where";
                            //print_r($sql);
                            $result = $db->query($sql);
                            if ($result->num_rows > 0) {
                                $i = 1;
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr style="font-size:13px;vertical-align:middle">
                                        ...
                                        <td>
                                            <a href="<?= WEB_PATH ?>reservation/cancel.php?reservation_no=<?= $row['reservation_no'] ?>" class="btn btn-danger btn-sm" style="text-align:center;vertical-align:middle;margin:0;padding:2px 5px;width:100px;font-size:13px;">Cancel Event</a>
                                        </td>
                                        <td>
                                            <a href="<?= WEB_PATH ?>arrangement_plan/arrangement_request.php?reservation_no=<?= $row['reservation_no'] ?>" class="btn btn-warning btn-sm" style="text-align:center;vertical-align:middle;margin:0;padding:2px 5px;width:100px;font-size:13px;">Request Plan</a>
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
