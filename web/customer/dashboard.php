                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 mb-3">
                                            ...
                                            $max = $row['max'];
                                            ?>
                                            <input type="number" min="<?= $min ?>" max="<?= $max ?>" class="form-control" name="guest_count" value="<?= @$guest_count ?>" style="font-size:13px;" placeholder="Count between 100 and 700">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                ...
                                                                ?>
                                                                <div class="col-md-6 mt-3 text-center" style="background-image:url('../../system/assets/images/hall/<?= $image ?>');background-size:cover;width:200px;height:270px;"></div>
                                                                <div class="col-md-6 mt-3">
                                                                    <div class="row">
                                                                        <div class="col-md-12" style="text-align:left">
                                                                            <p style="margin:5px;font-size:13px;">Minimum Capacity: <?= $row['min_capacity'] ?></p>
                                                                            <p style="margin:5px;font-size:13px;">Maximum Capacity: <?= $row['max_capacity'] ?></p>
                                                                            <p style="margin:5px;font-size:13px;">Facilities:</p>
                                                                            <?php
                                                                            if ($row['facilities']) {
                                                                                $facilities_list = explode(",", $row['facilities']);
                                                                                echo "<ul style='list-style-type:none'>";
                                                                                foreach ($facilities_list as $value) {
                                                                                    echo "<li style='font-size:13px;'><i class='bi bi-check-lg'></i>" . $value . "</li>";
                                                                                }
                                                                                echo "</ul>";
                                                                            }
                                                                            ?>
