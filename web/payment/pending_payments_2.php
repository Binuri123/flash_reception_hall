                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr style="font-size:13px;vertical-align:middle">
                                        ...
                                        if ($row['paid_status'] == NULL || $row['paid_status'] == '2') {
                                            ...
                                            ?>
                                            <td>
                                                <a href="<?= WEB_PATH ?>payment/edit.php?reservation_no=<?= $row['reservation_no'] ?>" class="btn btn-warning btn-sm" style="text-align:center;vertical-align:middle;width:120px;">Edit Payment</a>
                                            </td>
                                            <?php
                                        }
                                        ?>
