            ...
            <div class="card bg-success-light">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <p style="font-size:13px;"><strong><i>Your Payment has been Successfully Sent. Payment Verification is in Progress.Please Wait for the Status Update</i></strong></p>
                            <div class="row">
                                <div class="col-md-6">
                                    <p style="font-size:13px;"><strong><i>Back to <a href="<?= WEB_PATH ?>payment/payment.php" style="text-decoration:underline"> Payment History</a></i></strong></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1"></div>
