        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Verified Payments</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <?php
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <a href="<?= WEB_PATH ?>payment/verified_payments.php" class="btn btn-info btn-sm" style="font-size:10px;width:70px;"><i class="bi bi-eraser"></i> Clear</a>
                    </div>
                </div>
            </form>
        </div>
