    ...
    <section>
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Paid Payments</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
        <div class="row">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT p.receipt_no,p.reservation_no,r.discounted_price,pc.payment_category_name,"
                                        ...
                                        . "WHERE p.customer_no=(SELECT customer_no FROM customer WHERE customer_id=".$_SESSION['customer_id'].") AND p.payment_status='1'";
                                //print_r($sql);
                                $result = $db->query($sql);
                            ...
                            <tr style="font-size:13px;vertical-align:middle">
                                ...
                                <td>
                                    <a href="<?=WEB_PATH?>payment/edit.php?receipt_no=<?= $row['receipt_no'] ?>" class="btn btn-warning btn-sm" style="text-align:center;vertical-align:middle;margin:0;padding:2px 5px;"><i class="bi bi-pencil-square"></i></a>
                                </td>
                                <td>
