        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pending Refund Requests</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <?php
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <a href="<?= WEB_PATH ?>refund/refund_pending.php" class="btn btn-info btn-sm" style="font-size:13px;width:100px;"><i class="bi bi-eraser"></i> Clear</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-striped bg-light" style="font-size:13px;text-align:center;">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT rr.refund_request_id,r.reservation_id,r.reservation_no,r.event_date,c.canceled_date,rr.requested_date,"
                                    . "r.discounted_price,rs.reservation_status,rps.payment_status,rr.paid_amount,refundable_amount,pr.pending_reason FROM refund_request rr "
                                    ...
                                    . "LEFT JOIN refund_pending_reason pr ON pr.refund_request_id=rr.refund_request_id "
                                    . "WHERE rr.customer_no=(SELECT customer_no FROM customer WHERE customer_id=" . $_SESSION['customer_id'] . ") "
                                    . "AND rr.refund_status_id='3' $where";
                            //print_r($sql);
                            $result = $db->query($sql);
