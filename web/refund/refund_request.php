                        ...
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 mb-3">
                                    ...
                                    $sql_made_payments = "SELECT MAX(payment_category_id) as last_payment FROM customer_payments WHERE reservation_no='$reservation_no' "
                                    ...
                                    if ($timeDifferenceInHours < 4 && $last_payment >= '1') {
                                        ...
                                        $notice = "You have Canceled Your Reservation After 4 Hours. The Security Fee Will Not be Refunded According to the Reservation Policies.";
                                    }
                                    ?>
