...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    //var_dump($_POST);
    //var_dump(@$action_array[0]);
    //var_dump(@$action_array[1]);
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && @$action == 'save') {
        ...
        if (!empty($pax_count)) {
            if (!is_numeric($pax_count)) {
                $message['error_pax_count'] = "The Pax Count is Invalid...";
            } elseif ($pax_count < 0) {
                $message['error_pax_count'] = "The Pax Count Cannot Be Negative...";
            }
        }
        ...
        if (empty($message)) {
            ...
            $cDate = date('Y-m-d');
            $sql = "INSERT INTO package(package_name,event_id,menu_package_id,pax_count,total_price,service_charge,final_price,display_price,per_person_price,availability,add_user,add_date)VALUES('$package_name','$event_type','$menu_package','$pax_count','$total_price','$service_charge','$final_price','$display_price','$per_person_price','$availability','$userid','$cDate')";
            //print_r($sql);
            $db->query($sql);
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-8">
                                        ...
                                        <div class="text-danger"><?= @$message["error_menu_package"] ?></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-4">
...
//                                            var_dump(@$selected_service_price);
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-8">
                                        ...
                                        ?>
                                        <input type="text" class="form-control" style="font-size:13px;" id="display_price" name="display_price" value="<?= @$display_price ?>" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                    ...
                                    <div class="mb-3 col-md-8">
                                        ...
                                        ?>
                                        <input type="text" class="form-control" style="font-size:13px;" id="per_person_price" name="per_person_price" value="<?= @$per_person_price ?>" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-control form-select" id="service_category" name="service_category" onchange="form.submit()" style="font-size:13px;">
                                                    ...
                                                    $db = dbConn();
                                                    if (!empty($event_type)) {
                                                        $sql = "SELECT DISTINCT sc.category_id,sc.category_name FRom service_category sc LEFT JOIN service s ON s.category_id=sc.category_id WHERE s.service_id IN (SELECT service_id FROM event_service WHERE event_id = '$event_type')";
                                                    } else {
                                            ...
                                            <div class="col-md-6">
                                                <?php
                                                $item = array();
                                                if (!empty(@$service_category) && !empty($event_type)) {
                                                    $db = dbConn();
                                                    $sql = "SELECT service_id,service_name,final_price FROM service "
                                                            . "WHERE category_id=$service_category AND "
                                                            . "service_id IN (SELECT service_id FROM event_service WHERE event_id = '$event_type')";
                                                    $result = $db->query($sql);
