                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-8">
                                        <input type="number" min="1" class="form-control" id="pax_count" name="pax_count" value="<?= @$pax_count ?>" onchange="form.submit()">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                if (!empty(@$service_category) && !empty($event_type)) {
                                                    $db = dbConn();
                                                    $sql = "SELECT service_id,service_name,final_price FROM service WHERE category_id=$service_category AND service_id IN (SELECT service_id FROM event_service WHERE event_id = '$event_type')";
                                                    $result = $db->query($sql);
                                            ...
                                            <div class="col-md-10 table-responsive">
                                                <table class="table table-striped table-secondary">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        } else if ($_SERVER['REQUEST_METHOD'] == 'POST' && @$action == 'remove_service') {
                                                            if (!empty($_SESSION['selected_services'])) {
                                                                foreach ($_SESSION['selected_services'] as $unit) {
                                                                    ?>
                                                                    <tr>
