    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Custom Menu</li>
            </ol>
        </nav>
        <?php
        if ($_SESSION['user_role_id'] == '1' || $_SESSION['user_role_id'] == '2') {
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <a class="btn btn-sm btn-outline-success" href="<?= SYSTEM_PATH ?>menu_package/customized_menu/add.php"><i class="bi bi-plus-circle"></i> New Menu</a>
                </div>
            </div>
            <?php
        }
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <a href="<?= SYSTEM_PATH ?>menu_package/customized_menu/custom_menu.php" class="btn btn-info btn-sm" style="width:100px;font-size:13px;"><i class="bi bi-eraser"></i> Clear</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="table-responsive">
                <?php
                $sql = "SELECT menu_package_id,menu_package_name,total_price,final_price,availability FROM menu_package WHERE menu_type_id = 2 $where";
                //print_r($sql);
                $db = dbConn();
                $result = $db->query($sql);
                ?>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    if ($_SESSION['user_role_id'] == '1' || $_SESSION['user_role_id'] == '2') {
                                        ?>
                                        <td><a href="edit.php?menu_package_id=<?= $row['menu_package_id'] ?>" class="btn btn-warning btn-sm"><span data-feather="edit" class="align-text-bottom"></span></a></td>
                                        <?php
                                    }
                                    ?>
                                    <td><a href="view.php?menu_package_id=<?= $row['menu_package_id'] ?>" class="btn btn-info btn-sm"><span data-feather="eye" class="align-text-bottom"></span></a></td>
                                </tr>
                                <?php
                                $i++;
                            }
