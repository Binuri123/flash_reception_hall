...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && @$action == "add") {
        ...
        //Required Validation and Input Format Validation
        $message = array();
        ...
        if (empty($message) && !empty($_FILES['emp_image']['name'])) {
            $employee_image = uploadFiles("emp_image", $nic, "../assets/images/employee_images/profile_images/");
            print_r($employee_image);
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" onchange="form.submit()" type="radio" name="title" id="mr" value="Mr" <?php if (isset($title) && $title == 'Mr') { ?> checked <?php } ?> style="font-size:13px;">
                                    <label class="form-check-label" for="mr">Mr.</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" onchange="form.submit()" type="radio" name="title" id="mrs" value="Mrs" <?php if (isset($title) && $title == 'Mrs') { ?> checked <?php } ?> style="font-size:13px;">
                                    <label class="form-check-label" for="mrs">Mrs.</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" onchange="form.submit()" type="radio" name="title" id="miss" value="Miss" <?php if (isset($title) && $title == 'Miss') { ?> checked <?php } ?> style="font-size:13px;">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-3">
                                ...
                                <input type="text" class="form-control" id="middle_name" name="middle_name" value="<?= @$middle_name ?>" style="font-size:13px;">
                            ...
                            <div class="mb-2 col-md-3">
                                ...
                                <input type="text" class="form-control" id="calling_name" name="calling_name" value="<?= @$calling_name ?>" style="font-size:13px;">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-3">
                                ...
                                <input type="text" class="form-control" id="street" name="street" value="<?= @$street ?>" style="font-size:13px;">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-4">
                                <label for="alternate_number" class="form-label">Alternate Contact Number[Optional]</label>
                            ...
                            <div class="mb-2 col-md-4">
                                ...
                                <input type="text" class="form-control" id="email" name="email" value="<?= @$email ?>" style="font-size:13px;">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 col-md-4">
                                ...
                                <select class="form-control form-select" id="employment_status" name="employment_status" style="font-size:13px;">
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ?>
                                        <option value=<?= $row['emp_status_id']; ?> <?php if ($row['emp_status_id'] == @$employment_status) { ?> selected <?php } ?>><?= $row['emp_status_name'] ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="row">
                            <div class="mb-2 col-md-4">
                                ...
                                <select class="form-control form-select" id="user_role" name="user_role" onchange="form.submit()" style="font-size:13px;">
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ?>
                                        <option value=<?= $row['role_id']; ?> <?php if ($row['role_id'] == @$user_role) { ?> Selected <?php } ?>><?= $row['role_name'] ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <?php
                            if (!empty($user_role) && $user_role != '8') {
                                ?>
                                <div class="mb-2 col-md-4">
                                    <label for="username" class="form-label">Username</label>
                                    <?php
                                    if (isset($set_email) && $set_email == 'set' && !empty($email)) {
                                        @$username = $email;
                                    }
                                    ?>
                                    <input type="text" class="form-control" id="username" name="username" value="<?= @$username ?>" style="font-size:13px;">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="set_email" onchange="form.submit()" name="set_email" value="set" <?php if (@$set_email == 'set') { ?>checked<?php } ?> style="font-size:13px;">
                                        <label class="form-check-label" for="set_email">Use Email as Username</label>
                                    </div>
                                ...
                                <div class="mb-2 col-md-4">
                                    ...
                                    <div class="form-check form-check">
                                        <input class="form-check-input" type="checkbox" id="user_status" name="active_status" value="active_status" <?php if (@$active_status == 'Active') { ?>checked<?php } ?> style="font-size:13px;">
