...
<html lang="en">
  <head>
    ...
    <link href="assets/css/login_old.css" rel="stylesheet">
  </head>
        ...
        <?php
            if($_SERVER['REQUEST_METHOD']== "POST"){ 
                ...
                if(empty($message)){
                    ...
                    echo $sql = "SELECT * FROM users u LEFT JOIN user_role r ON r.role_id = u.role_id LEFT JOIN employee e ON e.user_id = u.user_id WHERE u.username = '$UserName' AND u.password = '$Password'";
                    $db = dbConn();
                    $result = $db->query($sql);
