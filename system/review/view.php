            ...
            <div class="card bg-light">
                ...
                <div class="card-body" style="font-size:13px;">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <div><?= (@$reply_status == NULL) ? 'Not Yet Replied' : @$reply_status ?></div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <div><?= (@$reply == NULL) ? 'Not Yet Replied' : @$reply ?></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <div><?= (@$replied_date == '0000-00-00') ? 'Not Yet Replied' : @$replied_date ?></div>
                        </div>
                    </div>
                </div>
            </div>
