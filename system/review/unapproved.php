            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3">
                        ...
                        <a href="<?= SYSTEM_PATH ?>review/unapproved.php" class="btn btn-info btn-sm" style="font-size:13px;width:100px;"><i class="bi bi-eraser"></i> Clear</a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped table-sm" style="font-size:13px;">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM customer_review r WHERE approval_status='Unapproved' $where ORDER BY r.add_date ASC";
                        //print_r($sql);
                        $db = dbConn();
                        $result = $db->query($sql);
