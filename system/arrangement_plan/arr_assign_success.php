...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="mt-3 pagetitle">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= SYSTEM_PATH ?>arrangement_plan/assign.php">Assignment</a></li>
                <li class="breadcrumb-item active" aria-current="page">Assignment Success</li>
            </ol>
        </nav>
    </div>
    <?php
    ...
    $sql_suppliers = "SELECT arr_assign_supplier_id,supplier_id,service_id FROM arr_assign_supplier WHERE arr_plan_id='$arr_plan_id' AND assign_status_id='1'";
    $result_suppliers = $db->query($sql_suppliers);
    if ($result_suppliers->num_rows > 0) {
        while ($row_suppliers = $result_suppliers->fetch_assoc()) {
            $reservation_date = $row_res['event_date'];
            $reservation_time = $row_res['start_time'] . " - " . $row_res['end_time'];
            $reserved_event = $row_res_event['event_name'];
            $reserved_hall = $row_res_hall['hall_name'];
            
            $sql_service_req = "SELECT service_name FROM service WHERE service_id='".$row_suppliers['service_id']."'";
            $result_service_req = $db->query($sql_service_req);
            $row_service_req = $result_service_req->fetch_assoc();
            $requested_service = $row_service_req['service_name'];
            
            $sql_supplier_name = "SELECT company_name FROM supplier WHERE supplier_id='".$row_suppliers['supplier_id']."'";
            $result_supplier_name = $db->query($sql_supplier_name);
            $row_supplier_name = $result_supplier_name->fetch_assoc();
            
            $to = 'binuridilara11@gmail.com';
            $recepient_name = $row_supplier_name['company_name'];
            $subject = 'Flash Reception Hall - Supplier Assignment Request';
            $body = "<p>We kindly request you to provide a confirmation of your eligibility to facilitate us with ".$requested_service." for the following event.</p>";
            $body .= "<br><br>";
            $body .= "<p>Event : ".$reserved_event."</p>";
            $body .= "<p>Date of the Event : ".$reservation_date."</p>";
            $body .= "<p>Time of the Event : ".$reservation_time."</p>";
            $body .= "<p>Reserved Hall : ".$reserved_hall."</p>";
            $body .= "<br><br>";
            $body .= "<p>You can inform your availability using the following link. Your timely confirmation will help us finalize the event schedule and make necessary arrangements.</p>";
            $body .= "<br>";
            $body .= "<p>http://localhost/flash_reception_hall/web/arrangement_plan/confirmation.php?arr_supplier_assign_id=".$row_suppliers['arr_assign_supplier_id']."</p>";
            $body .= "<br><br>";
            ...
            $alt_body = "<p>Supplier Assignment Request</p>";
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "AND service_id='2' AND assign_status_id = '1')";
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='3' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='4' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='5' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='8' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='9' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='10' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='11' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='12' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='13' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='14' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='15' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='17' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='18' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='23' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='25' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='26' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='27' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='28' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='29' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='30' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='31' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='33' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='32' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-7 mb-3">
                                            ...
                                            $sql_supplier = "SELECT company_name FROM supplier "
                                                    ...
                                                    . "(SELECT supplier_id FROM arr_assign_supplier "
                                                    . "WHERE arr_plan_id = '$arr_plan_id' "
                                                    . "AND service_id='34' AND assign_status_id = '1')";
                                            $result_supplier = $db->query($sql_supplier);
                                            $row_supplier = $result_supplier->fetch_assoc();
                                            ?>
                                            <p><strong><i><?= $row_supplier['company_name'] ?></i></strong></p>
