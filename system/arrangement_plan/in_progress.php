            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                <div class="row mb-3 align-items-end">
                    ...
                    <div class="col d-flex">
                        ...
                        <a href="<?= SYSTEM_PATH ?>arrangement_plan/in_progress.php" class="btn btn-info btn-sm flex-grow-1 ms-2" style="font-size:13px;font-style:italic;"><i class="bi bi-eraser"></i> Clear</a>
                    </div>
                </div>
            </form>
        </div>
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr style="vertical-align:middle;">
                                    ...
                                    if ($_SESSION['user_role_id'] == '1' || $_SESSION['user_role_id'] == '3' || $_SESSION['user_role_id'] == '6' || $_SESSION['user_role_id'] == '9') {
                                        ?>
                                        <td>
                                            <a href="<?= SYSTEM_PATH ?>arrangement_plan/re_assign.php?arr_plan_id=<?= $row['arrangement_plan_id'] ?>" class="btn btn-warning btn-sm"><i class="bi bi-list-ul"></i></a>
                                        </td>
                                        </td>
                                        <td>
                                            <a href="<?= SYSTEM_PATH ?>arrangement_plan/view.php?arr_plan_id=<?= $row['arrangement_plan_id'] ?>" class="btn btn-info btn-sm"><i class="bi bi-eye-fill"></i></a>
                                        </td>
                                        <?php
                                    }
                                    ?>
