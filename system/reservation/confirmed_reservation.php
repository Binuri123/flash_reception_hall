...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3>Confirmed Reservations List</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-3">
                        ...
                        <a href="<?= SYSTEM_PATH ?>reservation/confirm_reservation.php" class="btn btn-info btn-sm" style="font-size:13px;width:100px;"><i class="bi bi-eraser"></i> Clear</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <table class="table table-striped table-sm" style="font-size:13px;vertical-align: middle;text-align:center;">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM reservation r LEFT JOIN event e ON e.event_id=r.event_id "
                                . " WHERE r.reservation_status_id = '2' $where ORDER BY r.reservation_id ASC";
                        //print_r($sql);
                        $db = dbConn();
                        $result = $db->query($sql);
