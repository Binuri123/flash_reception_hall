...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Secured</li>
            </ol>
        </nav>
    </div>
    <?php
    ...
    <div class="row">
        <div class="col-md-12">
            <h3>Secured Reservations List</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                ...
                <table class="table table-striped table-sm" style="font-size:13px;vertical-align: middle;text-align:center;">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM reservation r LEFT JOIN event e ON e.event_id=r.event_id "
                                . " WHERE r.reservation_payment_status_id = '6' $where ORDER BY r.reservation_id ASC";
                        //print_r($sql);
                        $db = dbConn();
                        $result = $db->query($sql);
