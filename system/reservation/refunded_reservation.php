                ...
                <table class="table modified table-striped table-sm" style="font-size:13px;">
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT * FROM reservation r LEFT JOIN event e ON e.event_id=r.event_id "
                                . " WHERE r.reservation_payment_status_id = '4' "
                                . "OR r.reservation_payment_status_id = '5' $where ORDER BY r.add_date DESC";
                        //print_r($sql);
                        $db = dbConn();
                        $result = $db->query($sql);
