...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && @$action == 'add') {
        ...
        if (empty($message)) {
            ...
            $cDate = date('Y-m-d');
            $sql = "INSERT INTO service(category_id,service_name,service_type,addon_status,service_price,"
                    . "profit_ratio,final_price,availability,add_user,add_date)"
                    . "VALUES('$service_category','$service_name','$service_type','$addon_status',"
                    . "'$service_price','$profit_ratio','$final_price','$availability','$userid','$cDate')";
            $db->query($sql);
