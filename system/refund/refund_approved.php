    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Approved Refund Requests</li>
            </ol>
        </nav>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3>Approved Refund Request List</h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" >
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-3">
                                    ...
                                    <a href="<?= SYSTEM_PATH ?>refund/refund_approved.php" class="btn btn-info btn-sm" style="font-size:13px;width:100px;"><i class="bi bi-eraser"></i> Clear</a>
                                </div>
                            </div>
                        </form>
                    </div>
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                if ($_SESSION['user_role_id'] == '4' || $_SESSION['user_role_id'] == '1') {
                                                    ?>
                                                    <td style="text-align:center;"><a href="<?= SYSTEM_PATH ?>refund/issue.php?request_id=<?= $row['refund_request_id'] ?>" class="btn btn-warning btn-sm"><i class="bi bi-repeat"></i></a></td>
                                                    <?php
                                                }
                                                ?>
