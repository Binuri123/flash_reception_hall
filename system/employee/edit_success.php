    ...
    if ($_SERVER['REQUEST_METHOD'] == "GET") {
        ...
        if (!empty($employee_id)) {
            ...
            $sql = "SELECT * FROM employee e LEFT JOIN district d ON d.district_id=e.district_id "
                    ...
                    . "LEFT JOIN user u ON u.user_id=e.user_id WHERE e.employee_id='$employee_id'";
            //print_r($sql);
            $result = $db->query($sql);
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-sm table-bordered border-secondary">
                                            <thead class="bg-secondary-light border-dark text-center">
                                                <tr>
                                                    <th colspan="2">Updated Employee Details</th>
                                                </tr>
                                            </thead>
                                            <tbody style="font-weight:bold;">
                                                <tr>
                                                    <td>Employee Number</td>
                                                    <td class="<?= in_array('employee_no', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['employee_no'] ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Calling Name</td>
                                                    <td class="<?= in_array('calling_name', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['calling_name'] ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <?= $row['house_no'] . "," . $row['street'] . "," . $row['city'] . "," . $row['district_name'] ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Date of Birth</td>
                                                    <td class="<?= in_array('dob', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['dob'] ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td>Gender</td>
                                                    <td class="<?= in_array('gender', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['gender'] ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Designation</td>
                                                    <td class="<?= in_array('designation', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['designation_name'] ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Recruitment Date</td>
                                                    <td class="<?= in_array('recruitment_date', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['recruitment_date'] ?>   
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Employment Status</td>
                                                    <td class="<?= in_array('employement_status', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['employement_status_name'] ?>    
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Active Status</td>
                                                    <td class="<?= in_array('user_status', $updated_fields) ? 'text-warnning' : 'text-secondary' ?>">
                                                    <?= $row['user_status'] ?>
                                                    </td>
                                                </tr>
                                            </tbody>
