      ...
      <?php
        ...
        if($_SERVER['REQUEST_METHOD']== "POST"){
            ...
            if (empty($message)) {
                ...
                $sql = "INSERT INTO customers(title_id,first_name,last_name,house_no,street,city,district,mobile,land,email,nic,acceptance,status,user_id,add_date)VALUES('$title','$first_name','$last_name','$house_no','$street_name','$city','$district','$mobile','$land','$email','$nic','$acceptance','1','$userid','$cDate')";
                $db->query($sql);
                print_r($sql_insert_customer);
