                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT r.reservation_id,r.reservation_no,r.event_date,r.start_time,r.end_time,"
                                        ...
                                        . "WHERE customer_no=(SELECT customer_no FROM customer WHERE customer_id=".$_SESSION['customer_id'].") AND r.reservation_status_id='2'";
                                //print_r($sql);
                                $result = $db->query($sql);
                            ...
                            <tr style="font-size:13px;vertical-align:middle">
                                ...
                                <td>
                                    <a href="<?=WEB_PATH?>reservation/cancel.php?prev=confirm&reservation_id=<?= $row['reservation_id'] ?>" class="btn btn-danger btn-sm" style="text-align:center;vertical-align:middle;margin:0;padding:2px 5px;"><i class="bi bi-x-lg"></i></a>
                                </td>
                            </tr>
                            <?php
                                    }
